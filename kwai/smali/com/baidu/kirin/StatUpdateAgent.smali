...
.method static constructor <clinit>()V
    ...
    const-string/jumbo v1, "CheckUpdateManagerKirinAgent"
...
.method private static a(Landroid/content/Context;Ljava/lang/String;)Lorg/json/JSONObject;
    ...
    .line 181
    :cond_0
    const-string/jumbo v0, "can update!"
    ...
    const-string/jumbo v3, "updateResult is : "
    ...
    const-string/jumbo v0, "send update query error!!"
    ...
    .line 209
    :cond_3
    const-string/jumbo v0, "can not update"
    ...
    const-string/jumbo v4, "didn\'t send request! at moment : "
...
.method private static b(Landroid/content/Context;ILcom/baidu/kirin/PostChoiceListener;)V
    ...
    const-string/jumbo v1, "/kirinsdk/updatecommit"
...
.method private static b(Landroid/content/Context;ZLcom/baidu/kirin/CheckUpdateListener;)V
    ...
    .line 109
    const-string/jumbo v0, "updateResult is null, net error!"
    ...
    const-string/jumbo v4, "Error checking online version: "
    ...
    :cond_1
    :try_start_1
    const-string/jumbo v0, "atSetting"
    ...
    const-string/jumbo v4, "updateQuery\'s retCode is : "
    ...
    .line 136
    :cond_4
    const-string/jumbo v0, "appurl is null or appurl\'size is 0!"
    ...
    .line 140
    const-string/jumbo v0, "appurl is not start with http://"
    ...
    .line 153
    :cond_9
    const-string/jumbo v0, "KirinSDK protocol error when mutual with backend"
...
.method public static checkUpdate(Landroid/content/Context;ZLcom/baidu/kirin/CheckUpdateListener;)V
    ...
    const-string/jumbo v2, "sdkstat"

    aput-object v2, v0, v1

    const/4 v1, 0x1

    const-string/jumbo v2, "The param of CheckUpdateListener is null, please new a instance of CheckUpdateListener"
