...
.method private a(Ljava/lang/String;Ljava/lang/String;ILcom/igexin/push/extension/distribution/basic/b/m;Z)Landroid/app/PendingIntent;
    ...
    const-string/jumbo v1, "notifyStyle"
    ...
    const-string/jumbo v1, "bigStyle"
    ...
    const-string/jumbo v1, "2.10.3.1"

    const-string/jumbo v2, "2.10.3.0"
...
.method private c(Ljava/lang/String;Ljava/lang/String;Lcom/igexin/push/extension/distribution/basic/b/m;I)V
    ...
    invoke-direct {v7, v4}, Landroid/support/v4/app/ak$d;-><init>(Landroid/content/Context;)V

    invoke-virtual/range {p3 .. p3}, Lcom/igexin/push/extension/distribution/basic/b/m;->l()Ljava/lang/String;

    move-result-object v4

    invoke-virtual {v7, v4}, Landroid/support/v4/app/ak$d;->setContentText(Ljava/lang/CharSequence;)Landroid/support/v4/app/ak$d;

    invoke-virtual/range {p3 .. p3}, Lcom/igexin/push/extension/distribution/basic/b/m;->k()Ljava/lang/String;

    move-result-object v4

    invoke-virtual {v7, v4}, Landroid/support/v4/app/ak$d;->setContentTitle(Ljava/lang/CharSequence;)Landroid/support/v4/app/ak$d;
    ...
    const-string/jumbo v4, "getui_notification"
    ...
    invoke-virtual {v7, v6}, Landroid/support/v4/app/ak$d;->setPriority(I)Landroid/support/v4/app/ak$d;
...
.method public a(Lorg/json/JSONObject;)Lcom/igexin/push/core/bean/BaseAction;
    ...
    :try_start_2
    const-string/jumbo v7, "bigStyle"
    ...
    :cond_3
    :try_start_4
    const-string/jumbo v7, "getui_notification"
    ...
    const-string/jumbo v8, "2.10.3.1"

    const-string/jumbo v9, "2.6.0.0"
    ...
    const-string/jumbo v3, "getui_notification_style1"
    ...
    const-string/jumbo v7, "getui_notification_style3"
    ...
    const-string/jumbo v8, "getui_notification_icon"
    ...
    const-string/jumbo v9, "getui_notification_bg"
    ...
    const-string/jumbo v10, "getui_notification_date"
    ...
    const-string/jumbo v11, "getui_notification_icon2"
    ...
    const-string/jumbo v12, "getui_notification_style1_title"
    ...
    const-string/jumbo v13, "getui_notification_style1_content"
    ...
    const-string/jumbo v14, "getui_notification__style2_title"
    ...
    const-string/jumbo v15, "getui_notification_style3_content"
    ...
    const-string/jumbo v3, "@url:http"
    ...
    :try_start_8
    const-string/jumbo v7, "big_image_url"
    ...
    const-string/jumbo v7, "big_text"
...
.method public a(Ljava/lang/String;Ljava/lang/String;Lcom/igexin/push/extension/distribution/basic/b/m;I)V
    ...
    const-string/jumbo v7, "|use net logo bitmap is null = "
    ...
    :try_start_0
    const-string/jumbo v4, "com.android.internal.R$id"

    invoke-static {v4}, Ljava/lang/Class;->forName(Ljava/lang/String;)Ljava/lang/Class;

    move-result-object v4

    const-string/jumbo v5, "right_icon"
    ...
    const-string/jumbo v3, "reflect invoke setLatestEventInfo failed!"
    ...
    const-string/jumbo v3, "notification_background"
    ...
    const-string/jumbo v3, "update_notification_progressblock"
    ...
    const-string/jumbo v3, "app_download_notification"
    ...
    :cond_10
    const-string/jumbo v3, "2.10.3.1"

    const-string/jumbo v5, "2.3.0.0"
    ...
    const-string/jumbo v3, "getui_notification"
    ...
    const-string/jumbo v11, "getui_notification_icon"
    ...
    const-string/jumbo v12, "getui_notification_bg"
    ...
    const-string/jumbo v13, "getui_notification_date"
    ...
    const-string/jumbo v14, "getui_notification_icon2"
    ...
    const-string/jumbo v5, "getui_notification_style1_title"
    ...
    const-string/jumbo v7, "getui_notification_style1_content"
    ...
    const-string/jumbo v11, "<font> <h4>"
    ...
    const-string/jumbo v10, "</h4></font>"
    ...
    const-string/jumbo v3, "getui_notification_style2"
    ...
    const-string/jumbo v5, "getui_notification__style2_title"
    ...
    const-string/jumbo v3, "getui_notification_style3"
    ...
    const-string/jumbo v5, "getui_notification_style3_content"
