...
.method static constructor <clinit>()V
    ...
    .prologue
    .line 62
    const-class v0, Lcom/sina/weibo/sdk/api/a/l;

    invoke-virtual {v0}, Ljava/lang/Class;->getName()Ljava/lang/String;

    move-result-object v0

    sput-object v0, Lcom/sina/weibo/sdk/api/a/l;->a:Ljava/lang/String;
...
.method public constructor <init>(Landroid/content/Context;Ljava/lang/String;)V
    ...
    .line 71
    iput-object v1, p0, Lcom/sina/weibo/sdk/api/a/l;->d:Lcom/sina/weibo/sdk/b$a;

    .line 74
    const/4 v0, 0x1

    iput-boolean v0, p0, Lcom/sina/weibo/sdk/api/a/l;->e:Z

    .line 80
    iput-object v1, p0, Lcom/sina/weibo/sdk/api/a/l;->g:Landroid/app/Dialog;

    .line 89
    iput-object p1, p0, Lcom/sina/weibo/sdk/api/a/l;->b:Landroid/content/Context;

    .line 90
    iput-object p2, p0, Lcom/sina/weibo/sdk/api/a/l;->c:Ljava/lang/String;
    ...
    iput-object v0, p0, Lcom/sina/weibo/sdk/api/a/l;->d:Lcom/sina/weibo/sdk/b$a;

    .line 95
    iget-object v0, p0, Lcom/sina/weibo/sdk/api/a/l;->d:Lcom/sina/weibo/sdk/b$a;
    ...
    invoke-virtual {v0}, Lcom/sina/weibo/sdk/b$a;->toString()Ljava/lang/String;

    move-result-object v0

    invoke-static {v0}, Lcom/sina/weibo/sdk/b/d;->a(Ljava/lang/String;)V
    ...
    .line 98
    :cond_0
    const-string/jumbo v0, "WeiboInfo is null"
...
.method private static a(Landroid/app/Activity;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Landroid/os/Bundle;)Z
    ...
    .line 481
    :cond_0
    const-string/jumbo v1, "launchWeiboActivity fail, invalid arguments"

    invoke-static {v1}, Lcom/sina/weibo/sdk/b/d;->c(Ljava/lang/String;)V
    ...
    invoke-static {p0, v2}, Lcom/sina/weibo/sdk/b/j;->a(Landroid/content/Context;Ljava/lang/String;)Ljava/lang/String;
    ...
    const-string/jumbo v3, "launchWeiboActivity intent="
...
.method public final a()Z
    ...
    .prologue
    .line 132
    invoke-virtual {p0}, Lcom/sina/weibo/sdk/api/a/l;->b()I
...
.method public final a(Landroid/app/Activity;Lcom/sina/weibo/sdk/api/a/b;)Z
    ...
    .line 296
    :try_start_0
    iget-boolean v3, p0, Lcom/sina/weibo/sdk/api/a/l;->e:Z

    .line 3122
    iget-object v2, p0, Lcom/sina/weibo/sdk/api/a/l;->d:Lcom/sina/weibo/sdk/b$a;
    ...
    .line 2427
    iget-object v1, p0, Lcom/sina/weibo/sdk/api/a/l;->g:Landroid/app/Dialog;

    if-nez v1, :cond_4

    .line 2428
    iget-object v5, p0, Lcom/sina/weibo/sdk/api/a/l;->b:Landroid/content/Context;

    iget-object v6, p0, Lcom/sina/weibo/sdk/api/a/l;->f:Lcom/sina/weibo/sdk/api/a/d;
    ...
    invoke-static {v7}, Lcom/sina/weibo/sdk/b/j;->a(Landroid/content/Context;)Z
    ...
    .line 4071
    new-instance v4, Lcom/sina/weibo/sdk/api/a/k$1;

    invoke-direct {v4, v5}, Lcom/sina/weibo/sdk/api/a/k$1;-><init>(Landroid/content/Context;)V
    ...
    .line 4076
    new-instance v3, Lcom/sina/weibo/sdk/api/a/k$2;

    invoke-direct {v3, v6}, Lcom/sina/weibo/sdk/api/a/k$2;-><init>(Lcom/sina/weibo/sdk/api/a/d;)V
    ...
    .line 2441
    :cond_6
    invoke-virtual {p0}, Lcom/sina/weibo/sdk/api/a/l;->a()Z
    ...
    .line 2445
    :cond_7
    iget-object v2, p0, Lcom/sina/weibo/sdk/api/a/l;->b:Landroid/content/Context;

    iget-object v3, p0, Lcom/sina/weibo/sdk/api/a/l;->d:Lcom/sina/weibo/sdk/b$a;
    ...
    .line 304
    :cond_8
    iget-object v1, p0, Lcom/sina/weibo/sdk/api/a/l;->d:Lcom/sina/weibo/sdk/b$a;

    new-instance v2, Lcom/sina/weibo/sdk/api/a/j;

    invoke-direct {v2}, Lcom/sina/weibo/sdk/api/a/j;-><init>()V

    invoke-virtual {p2, v1}, Lcom/sina/weibo/sdk/api/a/b;->a(Lcom/sina/weibo/sdk/b$a;)Z
    ...
    .line 305
    const-string/jumbo v1, "sendRequest faild request check faild"
    ...
    .line 308
    :cond_9
    iget-object v0, p0, Lcom/sina/weibo/sdk/api/a/l;->b:Landroid/content/Context;

    iget-object v1, p0, Lcom/sina/weibo/sdk/api/a/l;->c:Ljava/lang/String;
    ...
    .line 311
    invoke-virtual {p2, v0}, Lcom/sina/weibo/sdk/api/a/b;->a(Landroid/os/Bundle;)V
    ...
    .line 312
    iget-object v3, p0, Lcom/sina/weibo/sdk/api/a/l;->c:Ljava/lang/String;

    invoke-static {p1, v1, v2, v3, v0}, Lcom/sina/weibo/sdk/api/a/l;->a(Landroid/app/Activity;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Landroid/os/Bundle;)Z
...
.method public final a(Landroid/content/Intent;Lcom/sina/weibo/sdk/api/a/e$a;)Z
    .locals 7
    ...
    .line 184
    const-string/jumbo v0, "handleWeiboResponse faild appPackage is null"
    ...
    .line 188
    const-string/jumbo v0, "handleWeiboResponse faild handler is not Activity"
    ...
    invoke-static {v4}, Lcom/sina/weibo/sdk/b/d;->a(Ljava/lang/String;)V
    ...
    .line 197
    const-string/jumbo v0, "handleWeiboResponse faild intent _weibo_transaction is null"
    ...
    .line 206
    :cond_2
    iget-object v3, p0, Lcom/sina/weibo/sdk/api/a/l;->b:Landroid/content/Context;
    ...
    .line 207
    const-string/jumbo v0, "handleWeiboResponse faild appPackage validateSign faild"
    ...
    .line 212
    invoke-interface {p2, v0}, Lcom/sina/weibo/sdk/api/a/e$a;->a(Lcom/sina/weibo/sdk/api/a/c;)V
...
.method public final c()Z
    ...
    iget-object v2, p0, Lcom/sina/weibo/sdk/api/a/l;->c:Ljava/lang/String;
    ...
    invoke-static {v0, v1}, Lcom/sina/weibo/sdk/b/j;->a(Landroid/content/Context;Ljava/lang/String;)Ljava/lang/String;
