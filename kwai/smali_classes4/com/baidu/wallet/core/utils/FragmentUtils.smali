...
.method public static goBackToFirstFragment(Landroid/support/v4/app/u;)V
    .locals 1

    if-eqz p0, :cond_0

    invoke-static {p0}, Lcom/baidu/wallet/core/BaseFragment;->logFragmentStack(Landroid/support/v4/app/u;)V

    invoke-virtual {p0}, Landroid/support/v4/app/u;->d()I
...
.method public static popBackStackImmediate(Landroid/support/v4/app/u;)Z
    .locals 1
...
.method public static startFragment(Landroid/content/Context;Landroid/support/v4/app/u;Landroid/support/v4/app/Fragment;Ljava/lang/String;Z)V
    .locals 5
    ...
    invoke-virtual {v0, v1, v2, v3, v4}, Landroid/support/v4/app/z;->a(IIII)Landroid/support/v4/app/z;

    :goto_0
    const v1, 0x102000c

    invoke-virtual {v0, v1, p2}, Landroid/support/v4/app/z;->b(ILandroid/support/v4/app/Fragment;)Landroid/support/v4/app/z;

    invoke-virtual {v0, p3}, Landroid/support/v4/app/z;->a(Ljava/lang/String;)Landroid/support/v4/app/z;
    ...
    invoke-virtual {v0, v3, v3, v1, v2}, Landroid/support/v4/app/z;->a(IIII)Landroid/support/v4/app/z;
