...
.method private constructor <init>(Landroid/content/Context;Ljava/util/Map;Lio/fabric/sdk/android/services/concurrency/g;Landroid/os/Handler;Lio/fabric/sdk/android/k;ZLio/fabric/sdk/android/f;Lio/fabric/sdk/android/services/common/IdManager;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object v0, p0, Lio/fabric/sdk/android/c;->g:Landroid/content/Context;
    ...
    .line 292
    iput-object v1, p0, Lio/fabric/sdk/android/c;->k:Lio/fabric/sdk/android/f;

    .line 293
    iput-object p8, p0, Lio/fabric/sdk/android/c;->l:Lio/fabric/sdk/android/services/common/IdManager;
...
.method public static varargs a(Landroid/content/Context;[Lio/fabric/sdk/android/h;)Lio/fabric/sdk/android/c;
    ...
    .line 310
    const-class v9, Lio/fabric/sdk/android/c;
    ...
    .line 312
    new-instance v7, Lio/fabric/sdk/android/c$a;

    invoke-direct {v7, p0}, Lio/fabric/sdk/android/c$a;-><init>(Landroid/content/Context;)V

    .line 3102
    iget-object v0, v7, Lio/fabric/sdk/android/c$a;->b:[Lio/fabric/sdk/android/h;
    ...
    :cond_0
    :try_start_1
    iput-object p1, v7, Lio/fabric/sdk/android/c$a;->b:[Lio/fabric/sdk/android/h;

    .line 3227
    iget-object v0, v7, Lio/fabric/sdk/android/c$a;->c:Lio/fabric/sdk/android/services/concurrency/g;

    if-nez v0, :cond_1

    .line 3228
    invoke-static {}, Lio/fabric/sdk/android/services/concurrency/g;->a()Lio/fabric/sdk/android/services/concurrency/g;

    move-result-object v0

    iput-object v0, v7, Lio/fabric/sdk/android/c$a;->c:Lio/fabric/sdk/android/services/concurrency/g;

    .line 3231
    :cond_1
    iget-object v0, v7, Lio/fabric/sdk/android/c$a;->d:Landroid/os/Handler;
    ...
    iput-object v0, v7, Lio/fabric/sdk/android/c$a;->d:Landroid/os/Handler;

    .line 3235
    :cond_2
    iget-object v0, v7, Lio/fabric/sdk/android/c$a;->e:Lio/fabric/sdk/android/k;

    if-nez v0, :cond_3

    .line 3236
    iget-boolean v0, v7, Lio/fabric/sdk/android/c$a;->f:Z
    ...
    iput-object v0, v7, Lio/fabric/sdk/android/c$a;->e:Lio/fabric/sdk/android/k;

    .line 3244
    :cond_3
    :goto_0
    iget-object v0, v7, Lio/fabric/sdk/android/c$a;->h:Ljava/lang/String;

    if-nez v0, :cond_4

    .line 3245
    iget-object v0, v7, Lio/fabric/sdk/android/c$a;->a:Landroid/content/Context;

    invoke-virtual {v0}, Landroid/content/Context;->getPackageName()Ljava/lang/String;

    move-result-object v0

    iput-object v0, v7, Lio/fabric/sdk/android/c$a;->h:Ljava/lang/String;

    .line 3248
    :cond_4
    iget-object v0, v7, Lio/fabric/sdk/android/c$a;->i:Lio/fabric/sdk/android/f;
    ...
    iput-object v0, v7, Lio/fabric/sdk/android/c$a;->i:Lio/fabric/sdk/android/f;
    ...
    iget-object v1, v7, Lio/fabric/sdk/android/c$a;->h:Ljava/lang/String;

    iget-object v3, v7, Lio/fabric/sdk/android/c$a;->g:Ljava/lang/String;
    ...
    iget-object v1, v7, Lio/fabric/sdk/android/c$a;->a:Landroid/content/Context;

    iget-object v3, v7, Lio/fabric/sdk/android/c$a;->c:Lio/fabric/sdk/android/services/concurrency/g;

    iget-object v4, v7, Lio/fabric/sdk/android/c$a;->d:Landroid/os/Handler;

    iget-object v5, v7, Lio/fabric/sdk/android/c$a;->e:Lio/fabric/sdk/android/k;

    iget-boolean v6, v7, Lio/fabric/sdk/android/c$a;->f:Z

    iget-object v7, v7, Lio/fabric/sdk/android/c$a;->i:Lio/fabric/sdk/android/f;

    invoke-direct/range {v0 .. v8}, Lio/fabric/sdk/android/c;-><init>(Landroid/content/Context;Ljava/util/Map;Lio/fabric/sdk/android/services/concurrency/g;Landroid/os/Handler;Lio/fabric/sdk/android/k;ZLio/fabric/sdk/android/f;Lio/fabric/sdk/android/services/common/IdManager;)V

    .line 5340
    sput-object v0, Lio/fabric/sdk/android/c;->a:Lio/fabric/sdk/android/c;

    .line 5364
    new-instance v1, Lio/fabric/sdk/android/a;

    iget-object v2, v0, Lio/fabric/sdk/android/c;->g:Landroid/content/Context;

    invoke-direct {v1, v2}, Lio/fabric/sdk/android/a;-><init>(Landroid/content/Context;)V

    iput-object v1, v0, Lio/fabric/sdk/android/c;->d:Lio/fabric/sdk/android/a;

    .line 5365
    iget-object v1, v0, Lio/fabric/sdk/android/c;->d:Lio/fabric/sdk/android/a;

    new-instance v2, Lio/fabric/sdk/android/c$1;

    invoke-direct {v2, v0}, Lio/fabric/sdk/android/c$1;-><init>(Lio/fabric/sdk/android/c;)V

    invoke-virtual {v1, v2}, Lio/fabric/sdk/android/a;->a(Lio/fabric/sdk/android/a$b;)Z

    .line 5383
    iget-object v1, v0, Lio/fabric/sdk/android/c;->g:Landroid/content/Context;

    invoke-direct {v0, v1}, Lio/fabric/sdk/android/c;->a(Landroid/content/Context;)V
    ...
    .line 4572
    invoke-static {v2, v0}, Lio/fabric/sdk/android/c;->a(Ljava/util/Map;Ljava/util/Collection;)V
    :try_end_2
...
.method private a(Landroid/content/Context;)V
    ...
    iget-object v1, p0, Lio/fabric/sdk/android/c;->l:Lio/fabric/sdk/android/services/common/IdManager;
    ...
    iget-object v5, p0, Lio/fabric/sdk/android/c;->l:Lio/fabric/sdk/android/services/common/IdManager;
    ...
    .line 420
    :cond_0
    invoke-virtual {v2}, Lio/fabric/sdk/android/l;->i()V
    ...
    const-string v1, "Initializing io.fabric.sdk.android:fabric [Version: 1.3.14.143"
    ...
    .line 435
    iget-object v4, v0, Lio/fabric/sdk/android/h;->g:Lio/fabric/sdk/android/g;

    iget-object v5, v2, Lio/fabric/sdk/android/l;->g:Lio/fabric/sdk/android/g;

    invoke-virtual {v4, v5}, Lio/fabric/sdk/android/g;->a(Lio/fabric/sdk/android/services/concurrency/h;)V
...
.method private static a(Ljava/util/Map;Lio/fabric/sdk/android/h;)V
    ...
    .prologue
    .line 460
    iget-object v0, p1, Lio/fabric/sdk/android/h;->k:Lio/fabric/sdk/android/services/concurrency/b;
    ...
    .line 468
    iget-object v6, p1, Lio/fabric/sdk/android/h;->g:Lio/fabric/sdk/android/g;

    iget-object v0, v0, Lio/fabric/sdk/android/h;->g:Lio/fabric/sdk/android/g;

    invoke-virtual {v6, v0}, Lio/fabric/sdk/android/g;->a(Lio/fabric/sdk/android/services/concurrency/h;)V
    ...
    .line 480
    :cond_2
    iget-object v5, p1, Lio/fabric/sdk/android/h;->g:Lio/fabric/sdk/android/g;
    ...
    invoke-virtual {v5, v0}, Lio/fabric/sdk/android/g;->a(Lio/fabric/sdk/android/services/concurrency/h;)V
...
.method static synthetic b(Lio/fabric/sdk/android/c;)Lio/fabric/sdk/android/f;
    ...
    .prologue
    .line 48
    iget-object v0, p0, Lio/fabric/sdk/android/c;->j:Lio/fabric/sdk/android/f;

    return-object v0
.end method

.method public static b()Lio/fabric/sdk/android/k;
    .locals 1
