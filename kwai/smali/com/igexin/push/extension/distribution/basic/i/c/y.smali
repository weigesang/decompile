...
# virtual methods
.method final a(Lcom/igexin/push/extension/distribution/basic/i/c/af;Lcom/igexin/push/extension/distribution/basic/i/c/b;)Z
    .locals 12
    ...
    const-string/jumbo v4, "article"

    aput-object v4, v1, v3

    const/4 v3, 0x2

    const-string/jumbo v4, "aside"
    ...
    const-string/jumbo v4, "fieldset"

    aput-object v4, v1, v3

    const/16 v3, 0xa

    const-string/jumbo v4, "figcaption"

    aput-object v4, v1, v3

    const/16 v3, 0xb

    const-string/jumbo v4, "figure"
    ...
    :cond_39
    const-string/jumbo v0, "This is a searchable index. Enter search keywords: "
    ...
    invoke-virtual {p2, v3}, Lcom/igexin/push/extension/distribution/basic/i/c/b;->d(Lcom/igexin/push/extension/distribution/basic/i/b/i;)Z

    move-result v1

    if-eqz v1, :cond_69

    invoke-virtual {p2, v3}, Lcom/igexin/push/extension/distribution/basic/i/c/b;->f(Lcom/igexin/push/extension/distribution/basic/i/b/i;)Lcom/igexin/push/extension/distribution/basic/i/b/i;

    move-result-object v3

    :cond_69
    invoke-virtual {p2, v3}, Lcom/igexin/push/extension/distribution/basic/i/c/b;->l(Lcom/igexin/push/extension/distribution/basic/i/b/i;)Z

    move-result v1

    if-nez v1, :cond_6a

    invoke-virtual {p2, v3}, Lcom/igexin/push/extension/distribution/basic/i/c/b;->e(Lcom/igexin/push/extension/distribution/basic/i/b/i;)Z
    ...
    invoke-virtual {v3}, Lcom/igexin/push/extension/distribution/basic/i/b/i;->a()Ljava/lang/String;
    ...
    invoke-direct {v1, v9, v10}, Lcom/igexin/push/extension/distribution/basic/i/b/i;-><init>(Lcom/igexin/push/extension/distribution/basic/i/c/ae;Ljava/lang/String;)V

    invoke-virtual {p2, v3, v1}, Lcom/igexin/push/extension/distribution/basic/i/c/b;->c(Lcom/igexin/push/extension/distribution/basic/i/b/i;Lcom/igexin/push/extension/distribution/basic/i/b/i;)V

    invoke-virtual {p2, v3, v1}, Lcom/igexin/push/extension/distribution/basic/i/c/b;->b(Lcom/igexin/push/extension/distribution/basic/i/b/i;Lcom/igexin/push/extension/distribution/basic/i/b/i;)V
    ...
    :cond_6d
    invoke-virtual {p2, v0}, Lcom/igexin/push/extension/distribution/basic/i/c/b;->a(Lcom/igexin/push/extension/distribution/basic/i/b/l;)V
    ...
    invoke-virtual {v2, v6}, Lcom/igexin/push/extension/distribution/basic/i/b/i;->a(Lcom/igexin/push/extension/distribution/basic/i/b/l;)Lcom/igexin/push/extension/distribution/basic/i/b/i;
    ...
    :cond_6f
    invoke-virtual {v2, v0}, Lcom/igexin/push/extension/distribution/basic/i/b/i;->a(Lcom/igexin/push/extension/distribution/basic/i/b/l;)Lcom/igexin/push/extension/distribution/basic/i/b/i;
...
.method final b(Lcom/igexin/push/extension/distribution/basic/i/c/af;Lcom/igexin/push/extension/distribution/basic/i/c/b;)Z
    .locals 4
