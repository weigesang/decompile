...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/v7/widget/bc;->i:Landroid/view/animation/Interpolator;
...
.method private b()Z
    ...
    .line 176
    iget-object v0, p0, Landroid/support/v7/widget/bc;->b:Landroid/support/v7/widget/ao;
...
.method protected final onConfigurationChanged(Landroid/content/res/Configuration;)V
    ...
    .line 230
    invoke-virtual {p0, v0}, Landroid/support/v7/widget/bc;->setContentHeight(I)V
...
.method public final onMeasure(II)V
    ...
    .line 101
    iget-object v4, p0, Landroid/support/v7/widget/bc;->b:Landroid/support/v7/widget/ao;
    ...
    .line 120
    iget-object v1, p0, Landroid/support/v7/widget/bc;->b:Landroid/support/v7/widget/ao;
    ...
    .line 1156
    iget-object v1, p0, Landroid/support/v7/widget/bc;->f:Landroid/widget/Spinner;
    ...
    invoke-direct {v2, v8, v6}, Landroid/support/v7/widget/ao$a;-><init>(II)V
    ...
    .line 1157
    iput-object v1, p0, Landroid/support/v7/widget/bc;->f:Landroid/widget/Spinner;

    .line 1159
    :cond_1
    iget-object v1, p0, Landroid/support/v7/widget/bc;->b:Landroid/support/v7/widget/ao;

    invoke-virtual {p0, v1}, Landroid/support/v7/widget/bc;->removeView(Landroid/view/View;)V
    ...
    invoke-virtual {p0, v1, v2}, Landroid/support/v7/widget/bc;->addView(Landroid/view/View;Landroid/view/ViewGroup$LayoutParams;)V
    ...
    new-instance v2, Landroid/support/v7/widget/bc$a;

    invoke-direct {v2, p0}, Landroid/support/v7/widget/bc$a;-><init>(Landroid/support/v7/widget/bc;)V
    ...
    iget v2, p0, Landroid/support/v7/widget/bc;->h:I
    ...
    .line 111
    :cond_8
    iput v6, p0, Landroid/support/v7/widget/bc;->c:I
    ...
    .line 124
    :cond_a
    invoke-direct {p0}, Landroid/support/v7/widget/bc;->b()Z
...
.method public final setTabSelected(I)V
    ...
    .line 1261
    iget-object v4, p0, Landroid/support/v7/widget/bc;->a:Ljava/lang/Runnable;
    ...
    invoke-virtual {p0, v4}, Landroid/support/v7/widget/bc;->removeCallbacks(Ljava/lang/Runnable;)Z

    .line 1264
    :cond_0
    new-instance v4, Landroid/support/v7/widget/bc$1;

    invoke-direct {v4, p0, v0}, Landroid/support/v7/widget/bc$1;-><init>(Landroid/support/v7/widget/bc;Landroid/view/View;)V
