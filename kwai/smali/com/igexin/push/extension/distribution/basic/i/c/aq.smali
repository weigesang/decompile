...
.method a()Lcom/igexin/push/extension/distribution/basic/i/c/af;
    ...
    const-string/jumbo v0, "Self closing flag not acknowledged"
...
.method a(Ljava/lang/Character;Z)Ljava/lang/Character;
    ...
    const-string/jumbo v0, "numeric reference with no numerals"
    ...
    :cond_7
    const-string/jumbo v0, "character outside of valid range"
    ...
    const-string/jumbo v0, "invalid named referenece \'%s\'"
    ...
    const-string/jumbo v0, "missing semicolon"
...
.method a(Lcom/igexin/push/extension/distribution/basic/i/c/af;)V
    ...
    const-string/jumbo v0, "Attributes incorrectly present on end tag"
