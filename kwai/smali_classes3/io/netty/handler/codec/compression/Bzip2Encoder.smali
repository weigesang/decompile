...
.method private a(Lio/netty/buffer/h;)V
    ...
    .prologue
    .line 160
    iget-object v1, p0, Lio/netty/handler/codec/compression/Bzip2Encoder;->f:Lio/netty/handler/codec/compression/c;

    .line 1284
    iget v0, v1, Lio/netty/handler/codec/compression/c;->b:I

    if-nez v0, :cond_1

    iget v0, v1, Lio/netty/handler/codec/compression/c;->e:I
    ...
    .line 162
    invoke-virtual {v1, p1}, Lio/netty/handler/codec/compression/c;->a(Lio/netty/buffer/h;)V

    .line 1292
    iget-object v0, v1, Lio/netty/handler/codec/compression/c;->a:Lio/netty/handler/codec/compression/l;
...
.method protected final synthetic a(Ljava/lang/Object;Lio/netty/buffer/h;)V
    .locals 10
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/lang/Exception;
    ...
    .line 3105
    invoke-virtual {p2, p1}, Lio/netty/buffer/h;->a(Lio/netty/buffer/h;)Lio/netty/buffer/h;
    ...
    .line 3147
    :pswitch_0
    invoke-direct {p0, p2}, Lio/netty/handler/codec/compression/Bzip2Encoder;->a(Lio/netty/buffer/h;)V
    ...
    invoke-virtual {p2, v0}, Lio/netty/buffer/h;->C(I)Lio/netty/buffer/h;
    ...
    invoke-virtual {p2, v0}, Lio/netty/buffer/h;->A(I)Lio/netty/buffer/h;
    ...
    .line 3128
    :goto_1
    invoke-virtual {p1}, Lio/netty/buffer/h;->O()Z
    ...
    .line 3129
    invoke-virtual {p1}, Lio/netty/buffer/h;->P()[B
    ...
    .line 4173
    iget v6, v8, Lio/netty/handler/codec/compression/c;->b:I

    iget v9, v8, Lio/netty/handler/codec/compression/c;->c:I
    ...
    invoke-virtual {p1, v2, v1}, Lio/netty/buffer/h;->a(I[B)Lio/netty/buffer/h;
    ...
    .line 4176
    :cond_5
    iget v6, v8, Lio/netty/handler/codec/compression/c;->d:I

    .line 4177
    iget v9, v8, Lio/netty/handler/codec/compression/c;->e:I
    ...
    .line 4181
    iput v4, v8, Lio/netty/handler/codec/compression/c;->e:I
    ...
    .line 4190
    iput v3, v8, Lio/netty/handler/codec/compression/c;->e:I
    ...
    iput v0, v8, Lio/netty/handler/codec/compression/c;->e:I

    goto :goto_5

    .line 3137
    :cond_9
    invoke-virtual {p1, v2}, Lio/netty/buffer/h;->z(I)Lio/netty/buffer/h;

    .line 4276
    iget v0, v8, Lio/netty/handler/codec/compression/c;->b:I

    iget v1, v8, Lio/netty/handler/codec/compression/c;->c:I
