...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;IILandroid/content/res/Resources$Theme;)V
    ...
    iput-object v0, p0, Lcom/yxcorp/plugin/live/widget/SwitchableSpinner;->g:Landroid/support/v7/widget/i;
    ...
    iput-object v2, p0, Lcom/yxcorp/plugin/live/widget/SwitchableSpinner;->i:Landroid/support/v7/widget/ak;
    ...
    .line 285
    :cond_4
    iget-object v0, p0, Lcom/yxcorp/plugin/live/widget/SwitchableSpinner;->g:Landroid/support/v7/widget/i;

    .line 4045
    iget-object v1, v0, Landroid/support/v7/widget/i;->a:Landroid/view/View;
    ...
    invoke-static {v1, p2, v2, p3, v7}, Landroid/support/v7/widget/bk;->a(Landroid/content/Context;Landroid/util/AttributeSet;[III)Landroid/support/v7/widget/bk;
    ...
    iput v2, v0, Landroid/support/v7/widget/i;->c:I

    .line 4051
    iget-object v2, v0, Landroid/support/v7/widget/i;->b:Landroid/support/v7/widget/n;

    iget-object v3, v0, Landroid/support/v7/widget/i;->a:Landroid/view/View;
    ...
    invoke-virtual {v2, v3, v4}, Landroid/support/v7/widget/n;->b(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    .line 4054
    invoke-virtual {v0, v2}, Landroid/support/v7/widget/i;->a(Landroid/content/res/ColorStateList;)V
    ...
    .line 4058
    iget-object v2, v0, Landroid/support/v7/widget/i;->a:Landroid/view/View;

    sget v3, Landroid/support/v7/a/a$j;->ViewBackgroundHelper_backgroundTint:I

    .line 4059
    invoke-virtual {v1, v3}, Landroid/support/v7/widget/bk;->e(I)Landroid/content/res/ColorStateList;

    move-result-object v3

    .line 4058
    invoke-static {v2, v3}, Landroid/support/v4/view/x;->a(Landroid/view/View;Landroid/content/res/ColorStateList;)V
    ...
    .line 4062
    iget-object v0, v0, Landroid/support/v7/widget/i;->a:Landroid/view/View;
...
.method public getDropDownVerticalOffset()I
    ...
    invoke-virtual {v0}, Lcom/yxcorp/plugin/live/widget/SwitchableSpinner$b;->g()I
...
.method public getSupportBackgroundTintList()Landroid/content/res/ColorStateList;
    ...
    .line 526
    iget-object v1, p0, Lcom/yxcorp/plugin/live/widget/SwitchableSpinner;->g:Landroid/support/v7/widget/i;
    ...
    .line 10098
    iget-object v2, v1, Landroid/support/v7/widget/i;->d:Landroid/support/v7/widget/bi;

    if-eqz v2, :cond_0

    iget-object v0, v1, Landroid/support/v7/widget/i;->d:Landroid/support/v7/widget/bi;
...
.method protected onDetachedFromWindow()V
    ...
    invoke-virtual {v0}, Lcom/yxcorp/plugin/live/widget/SwitchableSpinner$b;->c()V
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    .prologue
    .line 430
    iget-object v0, p0, Lcom/yxcorp/plugin/live/widget/SwitchableSpinner;->i:Landroid/support/v7/widget/ak;
...
.method public performClick()Z
    ...
    invoke-virtual {v0}, Lcom/yxcorp/plugin/live/widget/SwitchableSpinner$b;->b()V
...
.method public setAdapter(Landroid/widget/SpinnerAdapter;)V
    ...
    .prologue
    .line 401
    instance-of v0, p1, Lcom/yxcorp/plugin/live/widget/h;
    ...
    check-cast p1, Lcom/yxcorp/plugin/live/widget/h;

    invoke-virtual {v0}, Landroid/content/Context;->getTheme()Landroid/content/res/Resources$Theme;

    move-result-object v0

    invoke-direct {v2, p1, v0}, Lcom/yxcorp/plugin/live/widget/SwitchableSpinner$a;-><init>(Lcom/yxcorp/plugin/live/widget/h;Landroid/content/res/Resources$Theme;)V
...
.method public setBackgroundDrawable(Landroid/graphics/drawable/Drawable;)V
    ...
    iput v1, v0, Landroid/support/v7/widget/i;->c:I

    .line 10084
    const/4 v1, 0x0

    invoke-virtual {v0, v1}, Landroid/support/v7/widget/i;->a(Landroid/content/res/ColorStateList;)V
...
.method public setBackgroundResource(I)V
    ...
    .line 10073
    iput p1, v1, Landroid/support/v7/widget/i;->c:I

    .line 10075
    iget-object v0, v1, Landroid/support/v7/widget/i;->b:Landroid/support/v7/widget/n;

    if-eqz v0, :cond_1

    iget-object v0, v1, Landroid/support/v7/widget/i;->b:Landroid/support/v7/widget/n;

    iget-object v2, v1, Landroid/support/v7/widget/i;->a:Landroid/view/View;
    ...
    invoke-virtual {v0, v2, p1}, Landroid/support/v7/widget/n;->b(Landroid/content/Context;I)Landroid/content/res/ColorStateList;

    move-result-object v0

    .line 10075
    :goto_0
    invoke-virtual {v1, v0}, Landroid/support/v7/widget/i;->a(Landroid/content/res/ColorStateList;)V
...
.method public setSupportBackgroundTintList(Landroid/content/res/ColorStateList;)V
    ...
    .line 10089
    iget-object v1, v0, Landroid/support/v7/widget/i;->d:Landroid/support/v7/widget/bi;
    ...
    iput-object v1, v0, Landroid/support/v7/widget/i;->d:Landroid/support/v7/widget/bi;

    .line 10092
    :cond_0
    iget-object v1, v0, Landroid/support/v7/widget/i;->d:Landroid/support/v7/widget/bi;

    iput-object p1, v1, Landroid/support/v7/widget/bi;->a:Landroid/content/res/ColorStateList;
    ...
    iput-boolean v2, v1, Landroid/support/v7/widget/bi;->d:Z
...
.method public setSupportBackgroundTintMode(Landroid/graphics/PorterDuff$Mode;)V
    ...
    iput-object p1, v1, Landroid/support/v7/widget/bi;->b:Landroid/graphics/PorterDuff$Mode;
    ...
    iput-boolean v2, v1, Landroid/support/v7/widget/bi;->c:Z
