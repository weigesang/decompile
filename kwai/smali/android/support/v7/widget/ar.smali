...
.field public e:Landroid/support/v7/widget/ai;
...
.field final m:Landroid/support/v7/widget/ar$e;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V
    ...
    .line 114
    iput-boolean v3, p0, Landroid/support/v7/widget/ar;->w:Z

    .line 116
    iput v2, p0, Landroid/support/v7/widget/ar;->h:I

    .line 118
    iput-boolean v2, p0, Landroid/support/v7/widget/ar;->x:Z

    .line 119
    iput-boolean v2, p0, Landroid/support/v7/widget/ar;->y:Z
    ...
    .line 123
    iput v2, p0, Landroid/support/v7/widget/ar;->j:I
    ...
    iput-object v0, p0, Landroid/support/v7/widget/ar;->m:Landroid/support/v7/widget/ar$e;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/ar;->n:Landroid/os/Handler;
    ...
    iput v1, p0, Landroid/support/v7/widget/ar;->t:I
    ...
    .line 264
    iput-boolean v3, p0, Landroid/support/v7/widget/ar;->v:Z
    ...
    iput-object v0, p0, Landroid/support/v7/widget/ar;->q:Landroid/widget/PopupWindow;
...
.method public a(Landroid/widget/ListAdapter;)V
    ...
    .prologue
    .line 283
    iget-object v0, p0, Landroid/support/v7/widget/ar;->A:Landroid/database/DataSetObserver;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/ar;->A:Landroid/database/DataSetObserver;

    .line 288
    :cond_0
    :goto_0
    iput-object p1, p0, Landroid/support/v7/widget/ar;->r:Landroid/widget/ListAdapter;

    .line 289
    iget-object v0, p0, Landroid/support/v7/widget/ar;->r:Landroid/widget/ListAdapter;
    ...
    .line 293
    :cond_1
    iget-object v0, p0, Landroid/support/v7/widget/ar;->e:Landroid/support/v7/widget/ai;
    ...
    iget-object v1, p0, Landroid/support/v7/widget/ar;->r:Landroid/widget/ListAdapter;
    ...
    iget-object v1, p0, Landroid/support/v7/widget/ar;->A:Landroid/database/DataSetObserver;
...
.method public b()V
    ...
    .line 2126
    iget-object v4, p0, Landroid/support/v7/widget/ar;->d:Landroid/content/Context;
    ...
    :goto_0
    invoke-virtual {p0, v4, v0}, Landroid/support/v7/widget/ar;->a(Landroid/content/Context;Z)Landroid/support/v7/widget/ai;

    move-result-object v0

    iput-object v0, p0, Landroid/support/v7/widget/ar;->e:Landroid/support/v7/widget/ai;

    .line 2146
    iget-object v0, p0, Landroid/support/v7/widget/ar;->B:Landroid/graphics/drawable/Drawable;
    ...
    iget-object v5, p0, Landroid/support/v7/widget/ar;->B:Landroid/graphics/drawable/Drawable;

    invoke-virtual {v0, v5}, Landroid/support/v7/widget/ai;->setSelector(Landroid/graphics/drawable/Drawable;)V

    .line 2149
    :cond_0
    iget-object v0, p0, Landroid/support/v7/widget/ar;->e:Landroid/support/v7/widget/ai;

    iget-object v5, p0, Landroid/support/v7/widget/ar;->r:Landroid/widget/ListAdapter;

    invoke-virtual {v0, v5}, Landroid/support/v7/widget/ai;->setAdapter(Landroid/widget/ListAdapter;)V

    .line 2150
    iget-object v0, p0, Landroid/support/v7/widget/ar;->e:Landroid/support/v7/widget/ai;

    iget-object v5, p0, Landroid/support/v7/widget/ar;->l:Landroid/widget/AdapterView$OnItemClickListener;

    invoke-virtual {v0, v5}, Landroid/support/v7/widget/ai;->setOnItemClickListener(Landroid/widget/AdapterView$OnItemClickListener;)V
    ...
    invoke-virtual {v0, v5}, Landroid/support/v7/widget/ai;->setOnItemSelectedListener(Landroid/widget/AdapterView$OnItemSelectedListener;)V
    ...
    invoke-virtual {v0, v5}, Landroid/support/v7/widget/ai;->setOnScrollListener(Landroid/widget/AbsListView$OnScrollListener;)V
    ...
    .line 2179
    iget-object v7, p0, Landroid/support/v7/widget/ar;->z:Landroid/view/View;
    ...
    .line 2190
    iget v8, p0, Landroid/support/v7/widget/ar;->j:I
    ...
    iget v4, p0, Landroid/support/v7/widget/ar;->j:I
    ...
    .line 2228
    :goto_3
    iget-object v5, p0, Landroid/support/v7/widget/ar;->q:Landroid/widget/PopupWindow;

    invoke-virtual {v5, v4}, Landroid/widget/PopupWindow;->setContentView(Landroid/view/View;)V

    .line 2243
    :goto_4
    iget-object v4, p0, Landroid/support/v7/widget/ar;->q:Landroid/widget/PopupWindow;
    ...
    .line 2250
    iget-boolean v5, p0, Landroid/support/v7/widget/ar;->v:Z
    ...
    iput v5, p0, Landroid/support/v7/widget/ar;->t:I
    ...
    .line 2456
    :goto_6
    iget-object v7, p0, Landroid/support/v7/widget/ar;->k:Landroid/view/View;

    .line 2261
    iget v8, p0, Landroid/support/v7/widget/ar;->t:I

    invoke-direct {p0, v7, v8, v5}, Landroid/support/v7/widget/ar;->a(Landroid/view/View;IZ)I

    move-result v5

    .line 2263
    iget-boolean v7, p0, Landroid/support/v7/widget/ar;->x:Z

    if-nez v7, :cond_3

    iget v7, p0, Landroid/support/v7/widget/ar;->s:I
    ...
    .line 643
    :goto_7
    invoke-virtual {p0}, Landroid/support/v7/widget/ar;->j()Z

    move-result v5

    .line 644
    iget-object v3, p0, Landroid/support/v7/widget/ar;->q:Landroid/widget/PopupWindow;

    iget v4, p0, Landroid/support/v7/widget/ar;->u:I

    invoke-static {v3, v4}, Landroid/support/v4/widget/i;->a(Landroid/widget/PopupWindow;I)V
    ...
    .line 659
    :goto_8
    iget v3, p0, Landroid/support/v7/widget/ar;->s:I
    ...
    iget-boolean v3, p0, Landroid/support/v7/widget/ar;->y:Z

    if-nez v3, :cond_16

    iget-boolean v3, p0, Landroid/support/v7/widget/ar;->x:Z
    ...
    .line 4456
    iget-object v1, p0, Landroid/support/v7/widget/ar;->k:Landroid/view/View;

    .line 680
    iget v2, p0, Landroid/support/v7/widget/ar;->g:I

    iget v3, p0, Landroid/support/v7/widget/ar;->t:I
    ...
    .line 2231
    iget-object v4, p0, Landroid/support/v7/widget/ar;->z:Landroid/view/View;
    ...
    .line 2268
    :cond_c
    iget v7, p0, Landroid/support/v7/widget/ar;->f:I
    ...
    .line 2288
    :goto_e
    iget-object v7, p0, Landroid/support/v7/widget/ar;->e:Landroid/support/v7/widget/ai;

    sub-int/2addr v5, v0

    invoke-virtual {v7, v3, v5}, Landroid/support/v7/widget/ai;->a(II)I
    ...
    .line 2291
    iget-object v5, p0, Landroid/support/v7/widget/ar;->e:Landroid/support/v7/widget/ai;

    invoke-virtual {v5}, Landroid/support/v7/widget/ai;->getPaddingTop()I
    ...
    .line 2292
    invoke-virtual {v7}, Landroid/support/v7/widget/ai;->getPaddingBottom()I
    ...
    .line 2270
    :pswitch_2
    iget-object v7, p0, Landroid/support/v7/widget/ar;->d:Landroid/content/Context;
    ...
    iget-object v9, p0, Landroid/support/v7/widget/ar;->H:Landroid/graphics/Rect;
    ...
    .line 2276
    :pswitch_3
    iget-object v3, p0, Landroid/support/v7/widget/ar;->d:Landroid/content/Context;
    ...
    iget-object v7, p0, Landroid/support/v7/widget/ar;->H:Landroid/graphics/Rect;
    ...
    .line 3456
    iget-object v3, p0, Landroid/support/v7/widget/ar;->k:Landroid/view/View;
    ...
    .line 675
    :cond_15
    iget v0, p0, Landroid/support/v7/widget/ar;->s:I
    ...
    .line 696
    :goto_10
    iget v4, p0, Landroid/support/v7/widget/ar;->s:I
    ...
    iget-object v4, p0, Landroid/support/v7/widget/ar;->o:Landroid/graphics/Rect;
    ...
    invoke-virtual {v0, v6}, Landroid/support/v7/widget/ai;->setSelection(I)V
    ...
    .line 726
    :cond_1b
    invoke-virtual {p0}, Landroid/support/v7/widget/ar;->i()V
    ...
    .line 729
    iget-object v0, p0, Landroid/support/v7/widget/ar;->n:Landroid/os/Handler;
...
.method public final b(I)V
    ...
    iput-boolean v0, p0, Landroid/support/v7/widget/ar;->v:Z
...
.method public final c()V
    ...
    .line 6760
    iget-object v1, p0, Landroid/support/v7/widget/ar;->z:Landroid/view/View;
    ...
    .line 742
    iput-object v2, p0, Landroid/support/v7/widget/ar;->e:Landroid/support/v7/widget/ai;

    .line 743
    iget-object v0, p0, Landroid/support/v7/widget/ar;->n:Landroid/os/Handler;

    iget-object v1, p0, Landroid/support/v7/widget/ar;->m:Landroid/support/v7/widget/ar$e;
...
.method public final f()V
    ...
    .line 331
    iput-boolean v1, p0, Landroid/support/v7/widget/ar;->p:Z
...
.method public final g()I
    ...
    .prologue
    .line 489
    iget-boolean v0, p0, Landroid/support/v7/widget/ar;->v:Z
    ...
    :cond_0
    iget v0, p0, Landroid/support/v7/widget/ar;->t:I
